...
public class TwoArray {
	...
	public static void main(String[] args) {
		...
		twoDPrinter2(new int[][] { { 1, 2, 3 }, { 4, 5, 6 } });
		int[][] myArr = { { 7, 8 }, { 9, 10 } };
		twoDPrinter2(myArr);

		System.out.println(Arrays.deepToString(get2DArray2(2, 3)));
		int x = 4, y = 5;
		int[][] newArr = get2DArray2(x, y);
	...
	public static void twoDPrinter2(int[][] nums) {

		for (int eachItem[] : nums) {

			for (int eachNum : eachItem) {
				System.out.print(eachNum + " ");
	...
	public static int[][] get2DArray2(int row2, int col2) {

		int[][] myArr = new int[row2][col2];
