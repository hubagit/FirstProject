...
public class WARMUP {
	...
	public static void main(String[] args) {
		...
		// in another word , an object can be refered by it's own type or it's super
		// class type
		/// or it's interface type that the class implemeted

		// Power of Polymorphism --
		/// making correct decision at runtime according actual object type to call the
		// overriden version of the method
		...
		// we can group objects together by it's general types and take general actions
